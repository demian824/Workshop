...
router.get("/casual",(req, res) => {
    res.render("meal/meal",{
        ...
        category: mealModule.returnCategory(mealModule.getCasual())
    });
});
router.get("/classic",(req, res) => {
    res.render("meal/meal",{
        items: mealModule.getClassic(),
        category: mealModule.returnCategory(mealModule.getClassic())
    });
});
router.get("/ethnic",(req, res) => {
    res.render("meal/meal",{
        items: mealModule.getEthnic(),
        category: mealModule.returnCategory(mealModule.getEthnic())
    });
});
router.get("/seasonal",(req, res) => {
    res.render("meal/meal",{
        items: mealModule.getSeasonal(),
        category: mealModule.returnCategory(mealModule.getSeasonal())
    });
});
